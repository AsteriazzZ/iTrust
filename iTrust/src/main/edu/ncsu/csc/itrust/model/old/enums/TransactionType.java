...
public enum TransactionType {
	...
	ULTRASOUND_UPDATE(9403, "Ultrasound", "updated ultrasound records", true),
	CREATE_CHILDBIRTH_VISIT(9600, "Create Childbirth Visit", "created record for childbirth visit", true),
	EDIT_CHILDBIRTH_VISIT(9604, "Edit Childbirth Visit", "editied record for childbirth visit", true),
	ADD_CHILDBIRTH_DRUGS(9601, "Add Childbirth drugs", "childbirth drugs administered", true),
	BABY_BORN(9602, "A Baby is Born", "childbirth record created for baby in visit record", true),
	CREATE_BABY_RECORD(9603, "Create Baby Record", "a record for the childbirth is created as a patient file", true),
	/**HOME_VIEW*/
	...
	/**OBSTETRIC INITIALIZATION */
	OBSTETRICS_RECORD_CREATE(9300, "Create Initial Obstetric Record", "created an obstetrics record", true),
	/**VIEW OBSTETRIC INITIALIZATION */
	OBSTETRICS_RECORD_VIEW(9301, "View Initial Obstetric Record", "viewed your obstetrics record", true),

	/**CREATE_OBSTETRIC_OFFICE_VISIT */
	CREATE_OBSTETRIC_OFFICE_VISIT(9400, "Create Obstetric Office Visit", "created an obstetric office visit", true),
	/**VIEW_OBSTETRIC_OFFICE_VISIT */
	VIEW_OBSTETRIC_OFFICE_VISIT(9401, "View Obstetric Office Visit", "viewed an obstetric office visit", true),
	/**VIEW_OBSTETRIC_OFFICE_VISIT */
	EDIT_OBSTETRIC_OFFICE_VISIT(9402, "Edit Obstetric Office Visit", "edited an obstetric office visit", true),

	/**SCHEDULE_NEXT_OBSTETRICS_OFFICE_VISIT**/
	SCHEDULE_NEXT_OBSTETRICS_OFFICE_VISIT(9404, "Scheduled Next Obstetrics Office Visit", "Scheduled Next Obstetrics Office Visit", true),
	/**SCHEDULE_NEXT_CHILDBIRTH_OFFICE_VISIT**/
	SCHEDULE_NEXT_CHILDBIRTH_OFFICE_VISIT(9405, "Scheduled Next Childbirth Office Visit", "Scheduled Next Childbirth Office Visit", true);
