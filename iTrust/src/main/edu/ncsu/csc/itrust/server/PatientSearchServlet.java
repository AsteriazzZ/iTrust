...
public class PatientSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String zeroPatientError = search.size() == 0 ? "Please retry with a valid name or MID " : "";
		StringBuffer result = new StringBuffer("<span class=\"searchResults\">Found " + search.size() + " Records. " + zeroPatientError + "</span>");
		if(isAudit){
