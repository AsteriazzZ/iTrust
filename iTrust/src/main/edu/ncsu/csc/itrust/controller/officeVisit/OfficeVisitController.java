...
public class OfficeVisitController extends iTrustController {
    ...
    public String getBabyOfficeVisitsForCurrentPatientJSON() {
        return new Gson().toJson(getBabyOfficeVisitsForPatient(sessionUtils.getCurrentPatientMID()));
    }
    ...
    public String getChildOfficeVisitsForCurrentPatientJSON() {
        return new Gson().toJson(getChildOfficeVisitsForPatient(sessionUtils.getCurrentPatientMID()));
    }
    ...
    public String getAdultOfficeVisitsForCurrentPatientJSON() {
	    return new Gson().toJson(getAdultOfficeVisitsForPatient(sessionUtils.getCurrentPatientMID()));
    }
