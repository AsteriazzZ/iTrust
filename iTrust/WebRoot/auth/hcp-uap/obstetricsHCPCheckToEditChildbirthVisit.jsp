...
<%@page import="edu.ncsu.csc.itrust.controller.childbirthVisit.ChildbirthVisitForm"%>

<%@include file="/global.jsp"%>

<%
    pageTitle = "iTrust - Childbirth HCP Check";
%>
...
<%
    ...
    if(personnelForm.getSpecialty().equals("OB/GYN")){
        if (visitID != null){
            response.sendRedirect("/iTrust/auth/hcp-uap/childBirthInitializationForm.xhtml?visitID="+ visitID);
        }else{
            response.sendRedirect("/iTrust/auth/hcp-uap/childBirthInitializationForm.xhtml");
        }
    }
...
<a href="viewOnlyObstetricsRecords.xhtml">Click here to return</a>
