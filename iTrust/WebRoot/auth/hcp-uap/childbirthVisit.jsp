...
<%
    pageTitle = "iTrust - Childbirth Visit";
%>
...
<%
    ...
    if (pidString == null || pidString.equals("") || 1 > pidString.length()) {
        ...
        response.sendRedirect("/iTrust/auth/getPatientID.jsp?forward=hcp-uap/childbirthVisit.jsp");
        return;
    }
    response.sendRedirect("/iTrust/auth/hcp-uap/viewOnlyObstetricsRecords.xhtml");
