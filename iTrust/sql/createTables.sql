...
(
	pregnancyID BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT(20) UNSIGNED NOT NULL,
	conceptionYear INT(4) NOT NULL,
	weeksPregnant INT(10) NOT NULL,
	laborHours INT(10) UNSIGNED NOT NULL,
	weightGain INT(10) UNSIGNED,
...
(
	...
	blood_pressure VARCHAR(7),
  FHR INT(3),
  multiPregnancy INT(2),
  lowLyingPlacenta VARCHAR(7),
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
)  ENGINE=MyISAM;
CREATE TABLE ultrasounds
(
	ultrasoundID BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	obstetricOfficeVisitID INT(10) UNSIGNED NOT NULL,
	patientMID BIGINT(20) UNSIGNED NOT NULL,
  crl INT(10) UNSIGNED NOT NULL,
  bpd INT(10) UNSIGNED NOT NULL,
  hc INT(10) UNSIGNED NOT NULL,
  fl INT(10) UNSIGNED NOT NULL,
  ofd INT(10) UNSIGNED NOT NULL,
  ac INT(10) UNSIGNED NOT NULL,
  hl INT(10) UNSIGNED NOT NULL,
  efw INT(10) UNSIGNED NOT NULL,
	PRIMARY KEY (ultrasoundID, obstetricOfficeVisitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
)  ENGINE=MyISAM;
CREATE TABLE ultrasoundImages
(
	ultrasoundID BIGINT(20) UNSIGNED NOT NULL,
	image LONGTEXT NOT NULL,
	PRIMARY KEY (ultrasoundID)
)  ENGINE=MyISAM;
...
(
	...
	apptType VARCHAR(10),
	preScheduled BOOLEAN default TRUE,
	deliveryType VARCHAR(50),
	pitocin BIGINT(20) UNSIGNED,
	nitrousOxide BIGINT(20) UNSIGNED,
	pethidine BIGINT(20) UNSIGNED,
	epiduralAnaesthesia BIGINT(20) UNSIGNED,
	magnesiumSulfate BIGINT(20) UNSIGNED,
	rhImmuneGlobulin BIGINT(20) UNSIGNED,
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID),
	FOREIGN KEY (locationID) REFERENCES hospitals(HospitalID)
)  ENGINE=MyISAM;
...
(
	birthID BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	visitID BIGINT(20) UNSIGNED NOT NULL,
	...
	PRIMARY KEY (birthID),
	FOREIGN KEY (visitID) REFERENCES childbirthVisits(visitID)
)  ENGINE=MyISAM;
